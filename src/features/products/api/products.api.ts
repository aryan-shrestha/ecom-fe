...
export async function createVariant(
  ...
  return httpClient.post<Variant>(`/admin/products/${productId}/variants`, data);
}
...
export async function updateVariant(
  ...
  return httpClient.patch<Variant>(`/admin/products/variants/${variantId}`, data);
}

export async function deactivateVariant(variantId: string): Promise<Variant> {
  return httpClient.post<Variant>(`/admin/products/variants/${variantId}/deactivate`);
}
...
export async function addProductImage(
  ...
  return httpClient.post<ProductImage>(`/admin/products/${productId}/images`, data);
}
...
export async function uploadProductImage(
  ...
  return httpClient.post<ProductImage>(`/admin/products/${productId}/images/upload`, formData, {
    headers: {
...
export async function removeProductImage(productId: string, imageId: string): Promise<void> {
  return httpClient.delete<void>(`/admin/products/${productId}/images/${imageId}`);
}
...
export async function reorderProductImages(
  ...
  return httpClient.post<{ message: string }>(`/admin/products/${productId}/images/reorder`, data);
}
...
export async function assignCategories(
  ...
  return httpClient.post<{ message: string }>(`/admin/products/${productId}/categories`, data);
}
